...
@implementation LiuNianView
{
    ...
    CGFloat widthForSmallGong;
    CGFloat xForSmallGong;
    CGFloat heightForBoshi;
    CGFloat widthForDaxian;
    CGFloat xForDaxian;
}
                  ...
                  andArrForZM:(NSMutableArray *)arrforzm
{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        //字典，为了取出一对宫
        dicForAllGong = @{@"命宫":@[@"命宫",@"迁移"],@"2":@[@"夫妻",@"官禄"],@"3":@[@"官禄",@"夫妻"],@"4":@[@"财帛",@"福德"],@"5":@[@"疾厄",@"父母"],@"6":@[@"子女",@"田宅"],@"7":@[@"兄弟",@"奴仆"]};
...
- (void)createFont
{
   ...
   //算星的高度
    heightForStar = [self returnStrHeight:@"紫\n味\n星" andFont:_otherFont andWidth:widthForStar andHeight:MAXFLOAT].height;
    
   //小限宫宽度
    widthForSmallGong = [self returnStrHeight:@"小仙命宫" andFont:_gongFont andWidth:MAXFLOAT andHeight:heightForSmallGong].width;
    xForSmallGong = (widthForGong - widthForSmallGong) / 2.0;
    
   //博士高度
    heightForBoshi = [self returnStrHeight:@"博\n士" andFont:_otherFont andWidth:widthForBoshi andHeight:MAXFLOAT].height;
    
   //大限
    widthForDaxian = [self returnStrHeight:@"100-100" andFont:_daxianFont andWidth:MAXFLOAT andHeight:heightForDaxian].width;
    xForDaxian = (widthForGong - widthForDaxian) / 2.0;
...
//        [viewForText addSubview:labelForChangsheng];
       ...
       // labelForBoshi.backgroundColor = [UIColor orangeColor];
        ...
        [labelForBoshi sizeThatFits:CGSizeMake(widthForBoshi, heightForBoshi)];
        ...
        [labelForShengxiao sizeThatFits:CGSizeMake(widthForBoshi, heightForBoshi)];
