...
#define widthForCellK 32 / 750.0 * kScreenWidth
#define heightForCellK  18 / 1334.0 * kScreenHeight


#define xForBtnG 700 / 750.0 * kScreenWidth
#define yForBtnG 24 / 1334.0 * kScreenHeight

#define xForBtnK 686 / 750.0 * kScreenWidth
#define yForBtnK 40 / 1334.0 * kScreenHeight
...
- (void)createZijiangTb
{
    ...
    UILabel *labelForTitle = [[UILabel alloc]initWithFrame:CGRectMake(0, pageHeightBtn, kScreenWidth, yForTitle)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        if (_flag[indexPath.section]) {
            ...
            cell.imageForBtn.image = [UIImage imageNamed:@"展开"];
            cell.imageForBtn.size = CGSizeMake(widthForCellK, heightForCellK);
            cell.imageForBtn.origin = CGPointMake(xForBtnK, yForBtnK);

        }else{
        
           
            cell.imageForBtn.image = [UIImage imageNamed:@"收起"];
            cell.imageForBtn.size = CGSizeMake(heightForCellK, widthForCellK);
            cell.imageForBtn.origin = CGPointMake(xForBtnG, yForBtnG);
        }
