...
- (void)viewDidLoad {
    ...
    NSLog(@"%@",adId);
    //989B414E-F6ED-4567-AC40-C2B0E169510A
    
    NSUserDefaults *defalut = [NSUserDefaults standardUserDefaults];
    
    if (![defalut objectForKey:@"张三"]) {
        
        
        [defalut setBool:YES forKey:@"张三"];
        [defalut setBool:YES forKey:@"1992年09月08日17时"];
    }

    
    //算宜忌
    CalculateRightWrong *cal = [[CalculateRightWrong alloc]init];
    
    _dicForYiji = [cal suanYiji];
...
- (void)actionForViewAnimate:(BOOL )isHidden
{
    if (isHidden) {
        ...
        _homePage.dajiangtang.userInteractionEnabled = YES;
        _homePage.xiaoxianliunian.userInteractionEnabled = YES;
        _homePage.shengxiaodizhi.userInteractionEnabled = YES;
        ...
        _homePage.dajiangtang.userInteractionEnabled = NO;
        _homePage.xiaoxianliunian.userInteractionEnabled = NO;
        _homePage.shengxiaodizhi.userInteractionEnabled = NO;
...
- (void)actionForToady
{
    ...
    _homePage.wrongLabel.text = _dicForYiji[@"忌"];
    _homePage.rightLabel.text = _dicForYiji[@"宜"];
